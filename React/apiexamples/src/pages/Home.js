...
function Home() {
  return (
    <div>
     ...
     <p className="homeH2p">Inside the hamburger menus are my examples</p>
     ...
     <a href="/newsSearch" className="homeLinks">News Search</a>
     ...
     <a href="breakingBad">Breaking Bad</a>
