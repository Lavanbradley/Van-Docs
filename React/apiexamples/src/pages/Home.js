...
function Home() {
  return (
    <div className="home">
     ...
     <p className="homeH2p">1) My first example is called News Search. I am using the New York Times API to display new articles to the browser. I also have a search feature attached. Give it a try!</p>
